...
classdef bagOfFeatures < EnforceScalarHandle & matlab.mixin.CustomDisplay
    ...
    methods (Hidden, Access = protected)
        ...
        function clusterCenters = createVocabulary(this, descriptors, varargin)
            ...
            format longg
            T=readtable("C:/Users/Amir/Desktop/self/centroid.txt"); % your text file , attached sample.txt with this answer
            T=table2cell(T);
            a=cell2mat(T(cellfun(@isnumeric,T)));
            Result = reshape(transpose(a),[500,32]);
            clusterCenters = single(Result);
    ...
    methods (Hidden, Static, Access = protected)
        ...
        function d = getDefaultSettings
            ...
            d.Verbose                   = true;
            d.UseParallel               = useParallelPreference();           
        ...
        function [imgSets, params] = parseInputs(varargin)                     
            ...
            parser.addParameter('UseParallel',       useParallelPreference());
            ...
            useParallel = validateUseParallel(parser.Results.UseParallel);
